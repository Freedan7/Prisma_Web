		...
		<script>
			...
			function submit(){
				...
				if(recoTaken=='Yes'){
					...
					window.location.href = '../submission/submit.php?recoPos=true&id='+id+'&docID='+user+'&recos='+recommendation+'&cases='+cases+'&time='+time;
				}
				else {
					window.location.href = '../submission/submit.php?recoNeg=true&id='+id+'&docID='+user+'&time='+time;
				}
