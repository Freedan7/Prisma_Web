<?php
	...
	if ($admissionMeds == 0) {
		...
		$admissionMeds = "</br></br>Patient medication history includes:</br>";
	}

	if ($numMeds == 0) {
		$medications = "</br></br>The patient has taken no medications within the past year. "
		."</br></br>";
	}
	else {
	...
	$patientDetailsText1 = 'Your patient is a(n) '.$patientAge.' year old '.$patientRace
		...
		.".</br></br> The patient has a history of ".$comorbidityCount."</br>";
