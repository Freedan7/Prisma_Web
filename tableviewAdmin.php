...
<html>
    ...
    <body>
    	...
    	<div id='envelope' class=container align='center' >
    				<br>
	        		<div id = 'patientlist'>
	        			<h4> Welcome to the Idealist Platform, Dr. <?php echo $docName ?>. </font></h4>
	        			<h4> You are currently logged in as an <text style='text-decoration: underline'>administrator</text>. <h4>
	        		</div>
	        		<br>
	        		<div id='here_table' align='center'> 
	        			...
	        			<?php
							...
							for( $i=0; $i<count($patient_detail1); $i++ ){
								...
								$attendingDoc = $patient_detail1[$i]['featureValueMap']['assign_doc'];
								...
								$story =  'This patient is a(n) '.$patientAge.' year old '.$patientRace
								...
								echo '<td width="20%" id="patIDs"><label id="ID'
									.$i.'"><a href='.$go_to_page.'?ptID='.$ptID.'&'.$user.'='.$attendingDoc.'>'
