<?php
	...
	if(isset($_GET['attempt1'])){
        ...
        header( 'Location: ../assessments/modelResults_v3.php?ptID='.$ptID.'&docID='.$username);
...
//        header( 'Location: LastScreen.php?id='.$username.'&scrnID=2');
        header( 'Location: ../assessments/recommendations.php?ptID='.$ptID.'&docID='.$username);
    }
		...
		header( 'Location: ../assessments/reviewResults.php?ptID='.$ptID.'&docID='.$username.'&outcome='.$outcome );
	        ...
	        header( 'Location: ../assessments/LastScreen.php?docID='.$docID.'&scrnID=2');
	}
		...
		if($outcomeHold==""){
			...
			//echo $outcome_next;
			header( 'Location: ../assessments/modelResults_v2.php?ptID='.$ptID.'&docID='.$username.'&outcome='.$outcome_next );
		}
	}
